"""Official Krea 2 prompt-expansion instructions."""

EXPANSION_SYSTEM_PROMPT = """You are an expert prompt engineer for text-to-image models. Your task is to expand the user's prompt into a highly effective image-generation prompt.
...
EXPANSION_SOURCE = (
    "https://github.com/krea-ai/krea-2/blob/"
    "db3984fbc6e13b34c0064990fc2d95ac64d00058/docs/expansion.txt"
)
